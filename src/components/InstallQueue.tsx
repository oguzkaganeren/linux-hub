// FIX: Update the InstallQueue component to visually indicate when an
// installation has failed. It now displays an error icon, status text, and
...
import { selectInstallQueue, removeFromQueue, install } from '../store/packagesSlice';
                        ...
                        {installQueue.map(app => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className={`flex items-center gap-4 p-2 rounded-lg ${isError ? 'bg-red-500/10' : ''}`}
                                >
                                    ...
                                    <div className="flex-grow overflow-hidden">
                                        ...
                                        {isError ? (
                                            ...
                                            <div className="flex items-center gap-2 mt-1">
                                                ...
                                                <span className="text-sm font-mono text-gray-600 dark:text-gray-400 w-12 text-right">{Math.round(progress)}%</span>
                                            </div>
                                        )}
                                    </div>
